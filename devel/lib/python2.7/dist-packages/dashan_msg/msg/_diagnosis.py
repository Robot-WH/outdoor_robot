...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_5B().pack(_x.initInfo, _x.hardwareInfo, _x.Node, _x.State, _x.Para))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.initInfo, _x.hardwareInfo, _x.Node, _x.State, _x.Para,) = _get_struct_5B().unpack(str[start:end])
      return self
