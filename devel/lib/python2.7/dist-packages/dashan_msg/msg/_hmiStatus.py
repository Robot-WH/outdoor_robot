...
float32 pos_y"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_10B2f().pack(_x.commLinkState, _x.buttonState, _x.batteryState, _x.batteryPercent, _x.temperature, _x.humidity, _x.smogAlert, _x.pushRodPos, _x.emergentState, _x.zhishancmdshow, _x.pos_x, _x.pos_y))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.commLinkState, _x.buttonState, _x.batteryState, _x.batteryPercent, _x.temperature, _x.humidity, _x.smogAlert, _x.pushRodPos, _x.emergentState, _x.zhishancmdshow, _x.pos_x, _x.pos_y,) = _get_struct_10B2f().unpack(str[start:end])
      return self
